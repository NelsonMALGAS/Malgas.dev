                                ...
                                <ScrollArea className="overflow-visible">
                                    <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                                        {experience.items.map((exp, index) => (
                                            <li
                                                key={index}
                                                className="bg-card shadow-md hover:shadow-xl transition-shadow duration-300 border border-border h-[200px] p-6 flex flex-col justify-between rounded-2xl"
                                            >
                                                <span className="text-[#00ff99] font-medium text-sm">
                                                    {exp.duration}
                                                </span>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 min-w-[650px] w-full mx-auto xl:mx-0">
                                    {about.info.map((item, index) => (
                                        ...
                                        >
                                            ...
                                            <span className="flex flex-col flex-wrap text-right font-semibold text-base text-foreground">
                                                {item.fieldValue}
                                            </span>
                                        </motion.div>
                                    ))}
